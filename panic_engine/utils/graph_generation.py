...
featuresDataPath = "processed_data/data/panic_dataset_%dsec_features.csv"
labelsDataPath = "processed_data/data/panic_dataset_%dsec_labels.csv"
fileTime = 30
...
def printCircularClassDistribution():
    ...
    label_names = ['Non-Panic (Label 0)', 'Panic (Label 1)']
